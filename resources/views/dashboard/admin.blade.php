                ...
                <div class="col-lg-6 col-md-6 mt-4 mb-4">
                    <div class="card z-index-2  ">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-sm "> (<span class="font-weight-bolder">+15%</span>) increase in this month
                            </p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                                <p class="mb-0 text-sm"> updated 1 month ago </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mt-4 mb-3">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-sm ">MOnthly expenditure</p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
