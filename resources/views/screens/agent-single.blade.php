...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="home.blade.php">Estate<span class="color-b">Agency</span></a>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item " href="{{ route('agents-grid') }}">Agents Grid</a>
                <a class="dropdown-item  active" href="{{ route('agent-single') }}">Agent Single</a>
            </div>
          </li>
          <li class="nav-item">
