      ...
      <div class="row">
            ...
            <div class="col-md-7 col-lg-7 section-md-t3">
              ...
              <div class="property-description">
                <p class="description color-text-a">
                    Discover the epitome of comfort and style in this immaculate 3-bedroom, 2.5-bathroom house nestled in the heart of a serene and friendly neighborhood.
                    With its contemporary design, thoughtful amenities, and prime location, this house offers an unparalleled living experience that caters to both relaxation and convenience.
                </p>
                <p class="description color-text-a no-margin">
                    Step into the bright and airy living space adorned with large windows that bathe the interior in natural light.
                    The open-concept layout seamlessly connects the living room, dining area, and gourmet kitchen, creating an ideal environment for gatherings and everyday living.
                    The fully equipped kitchen boasts sleek stainless steel appliances, granite countertops, and ample cabinetry for all your culinary needs.
                    Whether you're hosting a dinner party or preparing a quiet meal, this space is designed to inspire your inner chef.
                </p>
              </div>
        ...
        <div class="col-md-10 offset-md-1">
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-map" role="tabpanel" aria-labelledby="pills-map-tab"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.015396012736!2d36.82194661426428!3d-1.2920658960007845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f14dc98acbc37%3A0x27ee6f5b55c76f2c!2sNairobi%2C%20Kenya!5e0!3m2!1sen!2sus!4v1628639026355!5m2!1sen!2sus"
                width="100%" height="460" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="property-agent">
                ...
                <p class="color-text-a">
                    Our Rental Agent is well-versed in the local real estate market, armed with insights into neighborhoods, rental trends, and property availability.
                    Their dedication to understanding your preferences and needs ensures that they curate a tailored list of options that align with your lifestyle and aspirations..
                </p>
            ...
            <div class="col-md-12 col-lg-4">
              <div class="property-contact">
                  <form class="form-a" method="post" action="{{ route('comment') }}">
